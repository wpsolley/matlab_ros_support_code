function models = get_model_pose(model_name)
%--------------------------------------------------------------------------
% getModels
% This method will create an action client that talks to Gazebo's
% get_model_state action server to retrieve the pose of a given model_name.
%
% Inputs
...
try
    ...
    models = rosmessage('gazebo_msgs/GetModelStateResponse', 'DataFormat','struct');
end